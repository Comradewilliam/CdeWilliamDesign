    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 md:px-8 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h2 className="text-2xl font-bold mb-6">CdeWilliam<span className="text-blue-400">Design</span></h2>
            <p className="text-gray-400 mb-6">
              Creating exceptional digital experiences that transform brands and drive results.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">E-Commerce</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Mobile-First Design</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">SEO & Analytics</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Brand Strategy</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li>213 Makongo Juu Street</li>
              <li>Dar Es Salaam, DSM 15121</li>
              <li>info@cdewilliamdesign.com</li>
              <li>+255 746 525 852</li>
